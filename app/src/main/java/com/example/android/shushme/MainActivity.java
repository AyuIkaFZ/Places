...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (9) Create a boolean SharedPreference to store the state of the "Enable Geofences" switch and initialize the switch based on the value of that SharedPreference

        // TODO (10) Handle the switch's change event and Register/Unregister geofences based on the value of isChecked as well as set a private boolean mIsEnabled to the current switch's state
        ...
        // TODO (1) Create a Geofencing class with a Context and GoogleApiClient constructor that initializes a private member ArrayList of Geofences called mGeofenceList
        // TODO (2) Inside Geofencing, implement a public method called updateGeofencesList that given a PlaceBuffer will create a Geofence object for each Place using Geofence.Builder and add that Geofence to mGeofenceList
        // TODO (3) Inside Geofencing, implement a private helper method called getGeofencingRequest that uses GeofencingRequest.Builder to return a GeofencingRequest object from the Geofence list
        // TODO (4) Create a GeofenceBroadcastReceiver class that extends BroadcastReceiver and override onReceive() to simply log a message when called. Don't forget to add a receiver tag in the Manifest
        // TODO (5) Inside Geofencing, implement a private helper method called getGeofencePendingIntent that returns a PendingIntent for the GeofenceBroadcastReceiver class
        // TODO (6) Inside Geofencing, implement a public method called registerAllGeofences that registers the GeofencingRequest by calling LocationServices.GeofencingApi.addGeofences using the helper functions getGeofencingRequest() and getGeofencePendingIntent()
        // TODO (7) Inside Geofencing, implement a public method called unRegisterAllGeofences that unregisters all geofences by calling LocationServices.GeofencingApi.removeGeofences using the helper function getGeofencePendingIntent()
