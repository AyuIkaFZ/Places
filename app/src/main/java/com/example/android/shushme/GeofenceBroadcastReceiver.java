...
public class GeofenceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (geofencingEvent.hasError()) {
            ...
            // TODO (5) Call getGeofenceTransition to get the transition type and use AudioManager to set the phone ringer mode based on the transition type. Feel free to create a helper method (setRingerMode)
            // TODO (6) Show a notification to alert the user that the ringer mode has changed. Feel free to create a helper method (sendNotification)
            return;
        }
